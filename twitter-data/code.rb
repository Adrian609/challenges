...
twitter_data.each do |hash|
  hash.each do |category, data|
  	puts "#{hash.keys.first}: #{data['number of followers']} followers."
  end
end
puts "--------------------------------------------------"
...
twitter_data.each do |hash|
  hash.each do |category, data|
  	puts "#{hash.keys.first}'s latest tweet was #{data['latest tweet'].length} characters long."
  end
end
puts "--------------------------------------------------"
...
twitter_data.each do |hash|
  sum = 0
  hash.each do |category, data|
  	data['last twenty tweets'].each do |tweets|
    		sum += tweets.length
 		end
  end
...
twitter_data.each do |hash|
  hash.each do |category, data|
  	if data['number of followers'] > running_max
  		running_max = data['number of followers']
  		user_name = hash.keys.first
  	end
  end
end
puts "#{user_name} has the most followers with #{running_max} followers."
puts "--------------------------------------------------"
...
twitter_data.each do |hash|
  hash.each do |category, data|
  	if data['number of friends'] > running_max
  		running_max = data['number of friends']
  		user_name = hash.keys.first
  	end
  end
end
puts "#{user_name} has the most friends with #{running_max} friends."
puts "--------------------------------------------------"
...
twitter_data.each do |hash|
  hash.each do |category, data|
  	if data['number of tweets'] > running_max
  		running_max = data['number of tweets']
  		user_name = hash.keys.first
  	end
  end
end
puts "#{user_name} has the most tweets with #{running_max} tweets."
puts "--------------------------------------------------"
...
twitter_data.each do |hash|
  hash.each do |category, data|
    if data['description'] == nil
      puts "#{hash.keys.first}'s profile is without a description."
    end
  end
end
puts "--------------------------------------------------"
...
twitter_data.each do |hash|
  hash.each do |category, data|
    if data['location'] == nil
      puts "#{hash.keys.first}'s profile	 is without a location."
    end
  end
end
puts "--------------------------------------------------"
